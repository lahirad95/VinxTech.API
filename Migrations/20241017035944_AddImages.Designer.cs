...
namespace VinxTech.API.Migrations
{
    ...
    [Migration("20241017035944_AddImages")]
            ...
            modelBuilder.Entity("VinxTech.API.Models.Domain.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6979),
                            Description = "Has full access to all system features and can manage all users, settings, and roles.",
                            Name = "Super Admin",
                            UpdatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6980)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6984),
                            Description = "Can manage users and settings, but has limited access to sensitive system configurations.",
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6984)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6986),
                            Description = "Has access to basic features and functionalities necessary for daily operations.",
                            Name = "Employee",
                            UpdatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6987)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6989),
                            Description = "Responsible for handling transactions and managing customer payments.",
                            Name = "Cashier",
                            UpdatedAt = new DateTime(2024, 10, 17, 3, 59, 44, 252, DateTimeKind.Utc).AddTicks(6989)
                        });
                });
