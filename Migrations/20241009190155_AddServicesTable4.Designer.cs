...
namespace VinxTech.API.Migrations
{
    ...
    [Migration("20241009190155_AddServicesTable4")]
            ...
            modelBuilder.Entity("VinxTech.API.Models.Domain.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1969),
                            Description = "Has full access to all system features and can manage all users, settings, and roles.",
                            Name = "Super Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1970)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1972),
                            Description = "Can manage users and settings, but has limited access to sensitive system configurations.",
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1972)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1974),
                            Description = "Has access to basic features and functionalities necessary for daily operations.",
                            Name = "Employee",
                            UpdatedAt = new DateTime(2024, 10, 9, 19, 1, 54, 931, DateTimeKind.Utc).AddTicks(1974)
                        });
                });
