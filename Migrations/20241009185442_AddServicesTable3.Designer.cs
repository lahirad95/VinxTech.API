...
namespace VinxTech.API.Migrations
{
    ...
    [Migration("20241009185442_AddServicesTable3")]
            ...
            modelBuilder.Entity("VinxTech.API.Models.Domain.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4073),
                            Description = "Has full access to all system features and can manage all users, settings, and roles.",
                            Name = "Super Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4075)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4077),
                            Description = "Can manage users and settings, but has limited access to sensitive system configurations.",
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4078)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4079),
                            Description = "Has access to basic features and functionalities necessary for daily operations.",
                            Name = "Employee",
                            UpdatedAt = new DateTime(2024, 10, 9, 18, 54, 42, 468, DateTimeKind.Utc).AddTicks(4080)
                        });
                });
