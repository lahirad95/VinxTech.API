            ...
            modelBuilder.Entity("VinxTech.API.Models.Domain.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6399),
                            Description = "Has full access to all system features and can manage all users, settings, and roles.",
                            Name = "Super Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6401)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6405),
                            Description = "Can manage users and settings, but has limited access to sensitive system configurations.",
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6405)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6407),
                            Description = "Has access to basic features and functionalities necessary for daily operations.",
                            Name = "Employee",
                            UpdatedAt = new DateTime(2024, 10, 9, 20, 24, 55, 621, DateTimeKind.Utc).AddTicks(6408)
                        });
                });
